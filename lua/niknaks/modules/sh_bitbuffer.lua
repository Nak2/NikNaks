...
local log, abs, ldexp, frexp, floor, min, ceil, max, rawget, setmetatable, source = math.log, math.abs, math.ldexp, math.frexp, math.floor, math.min, math.ceil, math.max, rawget, setmetatable, jit.util.funcinfo( NikNaks.AutoInclude )["source"]
...
do
	...
	local bswap, rshift, band, brshift, source = bswap, rshift, band, brshift, source
